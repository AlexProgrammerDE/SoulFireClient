...
function compileProtos(): void {
  ...
  const command = `protoc --ts_out src/generated --ts_opt long_type_bigint --ts_opt optimize_code_size --ts_opt eslint_disable --ts_opt ts_nocheck --proto_path protos ${protoFiles.join(" ")}`;
