...
import type { AttackListResponse } from "./attack";
import type { AttackListRequest } from "./attack";
...
export interface IAttackServiceClient {
    ...
    /**
     * @generated from protobuf rpc: listAttacks(com.soulfiremc.grpc.generated.AttackListRequest) returns (com.soulfiremc.grpc.generated.AttackListResponse);
     */
    listAttacks(input: AttackListRequest, options?: RpcOptions): UnaryCall<AttackListRequest, AttackListResponse>;
}
/**
 * @generated from protobuf service com.soulfiremc.grpc.generated.AttackService
 */
export class AttackServiceClient implements IAttackServiceClient, ServiceInfo {
    ...
    listAttacks(input: AttackListRequest, options?: RpcOptions): UnaryCall<AttackListRequest, AttackListResponse> {
        ...
        return stackIntercept<AttackListRequest, AttackListResponse>("unary", this._transport, method, opt, input);
    }
}
