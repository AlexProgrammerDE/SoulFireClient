...
class GrpcLogEntry$Type extends MessageType<GrpcLogEntry> {
  ...
  create(value?: PartialMessage<GrpcLogEntry>): GrpcLogEntry {
    ...
    message.callId = 0n;
    message.sequenceIdWithinCall = 0n;
    message.type = 0;
    message.logger = 0;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* uint64 call_id */ 2:
          message.callId = reader.uint64().toBigInt();
          break;
        case /* uint64 sequence_id_within_call */ 3:
          message.sequenceIdWithinCall = reader.uint64().toBigInt();
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.sequenceIdWithinCall !== 0n)
