...
class ChannelData$Type extends MessageType<ChannelData> {
  ...
  create(value?: PartialMessage<ChannelData>): ChannelData {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.target = "";
    message.callsStarted = 0n;
    message.callsSucceeded = 0n;
    message.callsFailed = 0n;
    if (value !== undefined)
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* int64 calls_started */ 4:
          message.callsStarted = reader.int64().toBigInt();
          break;
        case /* int64 calls_succeeded */ 5:
          message.callsSucceeded = reader.int64().toBigInt();
          break;
        case /* int64 calls_failed */ 6:
          message.callsFailed = reader.int64().toBigInt();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* int64 num_events_logged */ 1:
          message.numEventsLogged = reader.int64().toBigInt();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* int64 subchannel_id */ 7:
          message.subchannelId = reader.int64().toBigInt();
          break;
        case /* string name */ 8:
          message.name = reader.string();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* int64 socket_id */ 3:
          message.socketId = reader.int64().toBigInt();
          break;
        case /* string name */ 4:
          message.name = reader.string();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* int64 server_id */ 5:
          message.serverId = reader.int64().toBigInt();
          break;
        case /* string name */ 6:
          message.name = reader.string();
          break;
...
class SocketData$Type extends MessageType<SocketData> {
  ...
  create(value?: PartialMessage<SocketData>): SocketData {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.streamsStarted = 0n;
    message.streamsSucceeded = 0n;
    message.streamsFailed = 0n;
    message.messagesSent = 0n;
    message.messagesReceived = 0n;
    message.keepAlivesSent = 0n;
    message.option = [];
    if (value !== undefined)
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* int64 streams_started */ 1:
          message.streamsStarted = reader.int64().toBigInt();
          break;
        case /* int64 streams_succeeded */ 2:
          message.streamsSucceeded = reader.int64().toBigInt();
          break;
        case /* int64 streams_failed */ 3:
          message.streamsFailed = reader.int64().toBigInt();
          break;
        case /* int64 messages_sent */ 4:
          message.messagesSent = reader.int64().toBigInt();
          break;
        case /* int64 messages_received */ 5:
          message.messagesReceived = reader.int64().toBigInt();
          break;
        case /* int64 keep_alives_sent */ 6:
          message.keepAlivesSent = reader.int64().toBigInt();
          break;
...
class GetTopChannelsRequest$Type extends MessageType<GetTopChannelsRequest> {
  ...
  create(value?: PartialMessage<GetTopChannelsRequest>): GetTopChannelsRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.startChannelId = 0n;
    message.maxResults = 0n;
    if (value !== undefined)
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* int64 start_channel_id */ 1:
          message.startChannelId = reader.int64().toBigInt();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* int64 start_server_id */ 1:
          message.startServerId = reader.int64().toBigInt();
          break;
        case /* int64 max_results */ 2:
          message.maxResults = reader.int64().toBigInt();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* int64 start_socket_id */ 2:
          message.startSocketId = reader.int64().toBigInt();
          break;
