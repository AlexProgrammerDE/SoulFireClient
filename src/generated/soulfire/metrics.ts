...
class MetricsSnapshot$Type extends MessageType<MetricsSnapshot> {
  ...
  create(value?: PartialMessage<MetricsSnapshot>): MetricsSnapshot {
    ...
    message.botsTotal = 0;
    message.packetsSentTotal = 0n;
    message.packetsReceivedTotal = 0n;
    message.bytesSentTotal = 0n;
    message.bytesReceivedTotal = 0n;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* uint64 packets_sent_total */ 4:
          message.packetsSentTotal = reader.uint64().toBigInt();
          break;
        case /* uint64 packets_received_total */ 5:
          message.packetsReceivedTotal = reader.uint64().toBigInt();
          break;
        case /* uint64 bytes_sent_total */ 6:
          message.bytesSentTotal = reader.uint64().toBigInt();
          break;
        case /* uint64 bytes_received_total */ 7:
          message.bytesReceivedTotal = reader.uint64().toBigInt();
          break;
...
class ServerMetricsSnapshot$Type extends MessageType<ServerMetricsSnapshot> {
  ...
  create(value?: PartialMessage<ServerMetricsSnapshot>): ServerMetricsSnapshot {
    ...
    message.heapUsedBytes = 0n;
    message.heapCommittedBytes = 0n;
    message.heapMaxBytes = 0n;
    message.nonHeapUsedBytes = 0n;
    message.threadCount = 0;
    message.daemonThreadCount = 0;
    message.gcCollectionCount = 0n;
    message.gcCollectionTimeMs = 0n;
    message.uptimeMs = 0n;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* uint64 heap_used_bytes */ 4:
          message.heapUsedBytes = reader.uint64().toBigInt();
          break;
        case /* uint64 heap_committed_bytes */ 5:
          message.heapCommittedBytes = reader.uint64().toBigInt();
          break;
        case /* int64 heap_max_bytes */ 6:
          message.heapMaxBytes = reader.int64().toBigInt();
          break;
        case /* uint64 non_heap_used_bytes */ 7:
          message.nonHeapUsedBytes = reader.uint64().toBigInt();
          break;
        ...
        case /* uint64 gc_collection_count */ 10:
          message.gcCollectionCount = reader.uint64().toBigInt();
          break;
        case /* uint64 gc_collection_time_ms */ 11:
          message.gcCollectionTimeMs = reader.uint64().toBigInt();
          break;
        case /* uint64 uptime_ms */ 12:
          message.uptimeMs = reader.uint64().toBigInt();
          break;
