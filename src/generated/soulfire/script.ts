    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* optional int64 max_execution_count */ 1:
          message.maxExecutionCount = reader.int64().toBigInt();
          break;
        case /* optional int64 max_execution_time_ms */ 2:
          message.maxExecutionTimeMs = reader.int64().toBigInt();
          break;
        ...
        case /* optional int64 max_state_store_entries */ 4:
          message.maxStateStoreEntries = reader.int64().toBigInt();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* int64 activation_count */ 4:
          message.activationCount = reader.int64().toBigInt();
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
...
class NodeCompleted$Type extends MessageType<NodeCompleted> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* int64 execution_time_nanos */ 4:
          message.executionTimeNanos = reader.int64().toBigInt();
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
  ...
  internalBinaryWrite(
    ...
    if (message.executionTimeNanos !== 0n)
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* int64 max_count */ 2:
          message.maxCount = reader.int64().toBigInt();
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
